...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { Email: peg$parseEmail },
      peg$startRuleFunction  = peg$parseEmail,

      peg$c0 = "@",
      peg$c1 = peg$literalExpectation("@", false),
      peg$c2 = function(email, domain) {
            if (email.length > 64) {
